...
namespace pswd {
    ...
    void add_digit(std::vector<std::string>&);
    void add_letters(std::vector<std::string>&);
    ...
    void add_up_case(std::vector<std::string>&);
    void add_low_case(std::vector<std::string>&);
